...
# BBQ-style model outputs; prefer fairllms.datasets.BBQ + fairllms/data/bbq for inputs.
...
```bash
pip install -e .
python -m fairllms.definition.encoder_only.extrinsic_bias.context_based_disparity.main
```
