...
equivalents live in :mod:`fairllms.metrics.functional`, in the style of
``sklearn.metrics``.
"""
...
from fairllms.metrics._compat import as_examples, require_mapping_keys, take, unwrap, warn_legacy
from fairllms.metrics.base import FairnessMetric, MetricResult
from fairllms.metrics.data import GroupPredictions
...
class EqualOpportunityGap(FairnessMetric):
    ...
    ``data`` is a :class:`~fairllms.metrics.data.GroupPredictions`.
