...
from fairllms.metrics.data import ContrastSpec, GroupWordPairs
...
class DiscoveryOfCorrelationsScore(FairnessMetric):
    ...
    ``data`` is a :class:`~fairllms.metrics.data.GroupWordPairs`. The two word
...
class ContrastBasedScore(FairnessMetric):
    ...
    ``data`` is a :class:`~fairllms.metrics.data.ContrastSpec` carrying the group
