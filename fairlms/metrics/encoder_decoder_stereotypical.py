...
class StereotypicalValueAttribution(FairnessMetric):
    ...
    ``data`` is a :class:`~fairlms.metrics.data.WordSets` whose ``target_1`` /
    ...
    def compute(
        ...
        **legacy: Any,
        ...
        if direction is None:
            from fairlms.definition.encoder_decoder.intrinsic_bias.stereotypical_association.sva.sva import (  # noqa: E501
