...
```python
from fairLLMs.metrics import DemographicNextTokenProportion
...
```bash
pip install -e .
python -m fairLLMs.definition.decoder_only.extrinsic_bias.demographic_representation.dnp.main
```
