"""Demo of ``ContextBasedDisparityScore`` on bundled BBQ jsonl with MNLI."""
...
from fairLLMs.datasets import BBQ
from fairLLMs.definition.encoder_only.extrinsic_bias.context_based_disparity.stimuli import (
    bbq_rows_to_protocol,
)
from fairLLMs.metrics import ContextBasedDisparityScore
